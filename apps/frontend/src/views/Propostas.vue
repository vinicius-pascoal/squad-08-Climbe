    ...
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
      ...
      <div class="flex items-center gap-2">
        <button
          ...
          class="cadastro shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] bg-brand-cad8fd border border-brand-3b67d0 text-brand-3b67d0 font-bold rounded-lg px-4 py-2 hover cursor-pointer ml-16"
